 ...
 */
@MappedSuperclass
public abstract class PurOrder<ProductItem extends PurOrderProductItem> implements Serializable {

    @Serial
    private static final long serialVersionUID = -4177044962405029086L;
